...
class CustomTabBar: UITabBar {
    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        let oneItem:UITabBarItem = UITabBarItem.init(title: "Payment", image: UIImage.init(named: "账单"), tag: 0)
        let twoItem:UITabBarItem = UITabBarItem.init(title: "Chart", image: UIImage.init(named: "图表"), tag: 1)
