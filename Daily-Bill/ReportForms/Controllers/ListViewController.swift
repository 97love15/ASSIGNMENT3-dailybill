...
//        aTableView.backgroundView = imageView
    ...
    */
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let dateString: String = String(format: "%@ %@", CalendarHelper.dateString(date: tally.date ?? "20190101", originFromat: "yyyyMMdd", resultFromat: "yyyyyearMMmonthddday"), CalendarHelper.weekDay(dateString: tally.date ?? "20190103" , format:"yyyyMMdd"))
