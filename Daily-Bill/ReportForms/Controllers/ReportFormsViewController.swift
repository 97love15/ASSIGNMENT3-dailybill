...
//    var summaryType: SummaryType = SummaryType.month
    ...
    lazy var spendingSelectView: SelectView = {
        ...
        selectView.titleLabel.text = "💰month payment："
    ...
    lazy var incomeSelectView: SelectView = {
        ...
        selectView.titleLabel.text = "👏month income："
...
//        aTableView.backgroundView = imageView
    ...
    */
    ...
    private func setupUI() -> Void {
        ...
        titleLabel.text = "chart for payment"
        ...
        self.quickDateSelectView.showYear { (year) in
            weakSelf?.dateSelectView.yearLabel?.text = String(format: "%dyear", year)
        }
        ...
        self.quickDateSelectView.didSelected { (year, month) in
            ...
            if month == 0{
                weakSelf?.spendingSelectView.titleLabel.text = "💰year outcome："
                weakSelf?.incomeSelectView.titleLabel.text = "year income："
            }else{
                weakSelf?.spendingSelectView.titleLabel.text = "💰month outcome："
                weakSelf?.incomeSelectView.titleLabel.text = "👏month income："
            }
        }
        ...
        refreshControl.attributedTitle = NSAttributedString(string: "payment updates")
